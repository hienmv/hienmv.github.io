...
2. Minh hoạ:
   ...
   1. Dưới đây là hình minh hoạ về sự liên kết của các node ở binomial heap trên: 
...
7. [sample code](https://www.nayuki.io/res/binomial-heap/binomialheap.py)
...
1. find-min O(1)
   1. Vì đã có 1 con trỏ heap-min-pointer trỏ tới root node chứa min-key, nên thao tác này có thể thực hiện với độ phức tạp thuật toán về mặt thời gian là O(1)
2. Insert O(1)
   1. Thêm mới 1 node vào fibonacci heap bằng cách tạo ra 1 tree mà root node chính là node muốn thêm vào, và thêm vào double linked list của các root node của các tree. 
...
4. Binomial heap: 
   1. https://brilliant.org/wiki/binomial-heap/
   2. https://www.youtube.com/watch?v=7UQd9SYUoNk
   3. https://en.wikipedia.org/wiki/Binomial_heap#Applications
   4. visualization: https://www.cs.usfca.edu/~galles/visualization/BinomialQueue.html
5. Fibonacci Heap:
   1. https://en.wikipedia.org/wiki/Fibonacci_heap
   2. [https://brilliant.org/wiki/fibonacci-heap/](https://brilliant.org/wiki/fibonacci-heap/#citation-3)
   3. https://www.cs.princeton.edu/~wayne/cs423/lectures/fibonacci-4up.pdf
   4. https://stackoverflow.com/questions/14333314/why-is-a-fibonacci-heap-called-a-fibonacci-heap
6. Paring Heap:
   1. https://brilliant.org/wiki/pairing-heap/
